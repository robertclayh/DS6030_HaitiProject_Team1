...
```{r}
# Create metric set with tweaked f_meas (this stays the same)
...
# Compute metrics from a tibble of predictions
...
calculate_metrics_cv <- function(cv_object, holdout, model_name, workflow, train_data) {
  # For training, use the cross-validated predictions:
  train_aug <- collect_predictions(cv_object)
  
  # For the holdout set, refit the workflow on the full training data:
